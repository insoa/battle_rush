...
namespace Pathfinding {
	...
	public abstract class AIBase : VersionedMonoBehaviour {
		...
		public float centerOffset { get { return height * 0.5f; } set { height = value * 2; } }
		...
		protected virtual void Update() {
			...
			// 	"::",
			// 	Time.time - lastRepath >= repathRate,
			...
			usingGravity = !(gravity == Vector3.zero) && (!updatePosition || rigid == null || rigid.isKinematic);
